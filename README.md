...
| [Coverage](https://github.com/tdayris/bigr_epicure_pipeline/blob/main/workflow/rules/peak-calling/seacr_callpeak.smk)                                                                                                                                          | BedTools  | [Snakemake-Wrapper: bedtools-genomecov](https://snakemake-wrappers.readthedocs.io/en/v1.32.1/wrappers/bedtools/genomecov.html) | Estimate raw coverage over the genome |
...
Single-sample peak calling was performed by two approaches. (1) [Macs2](https://snakemake-wrappers.readthedocs.io/en/stable/wrappers/macs2/callpeak.html) version [2.2.7.1](https://snakemake-wrappers.readthedocs.io/en/stable/wrappers/macs2/callpeak.html#software-dependencies) using both broad and narrow options. This covers « naïve » approach. (2) [SEACR](https://github.com/FredHutch/SEACR) version [1.3](https://github.com/tdayris/bigr_epicure_pipeline/blob/5bd8243af3f970ff934d4a1d2730592064ebad70/workflow/envs/seacr.yaml#L6) to cover cases in which signal was too low. This calling was performed over genome coverage assessed by [BedTools](https://bedtools.readthedocs.io/en/latest/content/tools/genomecov.html) version [2.31.0](https://snakemake-wrappers.readthedocs.io/en/stable/wrappers/bedtools/genomecov.html#software-dependencies). The peak annotation was done using [ChIPSeeker](https://bioconductor.org/packages/release/bioc/vignettes/ChIPseeker/inst/doc/ChIPseeker.html#peak-annotation) version [1.34.0](https://github.com/tdayris/bigr_epicure_pipeline/blob/main/workflow/envs/chipseeker.yaml), using [Org.eg.db](https://bioconductor.org/packages/3.16/data/annotation/html/org.Hs.eg.db.html) annotations version [3.16.0](https://github.com/tdayris/bigr_epicure_pipeline/blob/main/workflow/envs/chipseeker.yaml).
